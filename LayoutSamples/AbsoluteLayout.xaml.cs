...
namespace Hw6
{
	public partial class AbsoluteLayout : ContentPage
	{
		...
		async void UpdateSize()
		{
			...
			Xamarin.Forms.AbsoluteLayout.SetLayoutBounds(box, new Rectangle(0f, 0f, w, h));
			Xamarin.Forms.AbsoluteLayout.SetLayoutBounds(anchorVert, new Rectangle(.5, 0f, Xamarin.Forms.AbsoluteLayout.AutoSize, Xamarin.Forms.AbsoluteLayout.AutoSize));
		...
		async void UpdatePosition()
		{
			...
			float x = 0.0f;
			float y = 0.0f;
			Xamarin.Forms.AbsoluteLayout.SetLayoutBounds(box, new Rectangle(x, y, .25, .25));
			Xamarin.Forms.AbsoluteLayout.SetLayoutBounds(anchorVert, new Rectangle(x, y + (y * box.Height), 5, 5));
		...
		void UpdateLabel()
		{
			var rect = Xamarin.Forms.AbsoluteLayout.GetLayoutBounds(box);
